...
<body class="gray-bg">
	...
	<div class="ibox float-e-margins">
		...
		<div class="ibox-content">
			<form class="form-horizontal m-t" id="addformId" method="post" action="/pms/user">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input id="realnameId" name="realname"
				...
				<div class="form-group">
					<div class="col-sm-4 col-sm-offset-4">
						<button id="btn" class="btn btn-primary" type="submit">添加系统用户</button>
	...
	$(function(){
		$("#addformId").ajaxForm({
			beforeSubmit:function(){
				...
				var passwordFlag= checkInput("#passwordId",
						"#passwordMsg",
						/\S/,
						"请输入密码");
				
				var nameFlag= checkInput("#realnameId",
						"#realnameMsg",
						/^[\u4e00-\u9fa5]{2,}$/,
						"请输入正确的姓名");
				...
				var emailFlag = checkInput(
						...
						"请输入正确格式的电话号码");
				console.log(checkFlag + "," +passwordFlag + ","+ nameFlag
						+ "," + phoneFlag + "," + qqFlag
						+ "," + emailFlag);

				return checkFlag&& passwordFlag&& nameFlag && phoneFlag
						&& qqFlag && emailFlag;	
			},
			...
			success: function(data){
				if (data.code==20) {
					window.location.href = "/pms/welcome.jsp";
					alert(data.msg);
