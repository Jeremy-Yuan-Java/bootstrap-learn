				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"> <i class="fa fa-user"></i> <span
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="/pms/page/user/adduser.jsp"
								data-index="0">用户添加</a></li>
							<li><a class="J_menuItem" href="/pms/user?action=findAll">查询所有用户</a>
							</li>
							<li><a class="J_menuItem" href="/pms/user?action=findPage&currentPage=1&pageSize=10">分页查询</a>
							</li>
						</ul></li>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="welcome.jsp" frameborder="0" data-id="index_v1.html" seamless></iframe>
			</div>
			<div class="footer">
